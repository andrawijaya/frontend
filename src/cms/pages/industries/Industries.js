...
export default function Industries() {
    ...
    const getListIndustries = () => {
        OrganizationAPIs.getIndustries()
            .then((res) => {
    ...
    const confirmDeleteData = () => {
        OrganizationAPIs.deleteIndustryById(idDelete)
            .then((res) => {
                setisFetch(!isFetch)
                setShowAlert(true)
                setAlerType(1)
            ...
            <div className="wrap-inside-industries">
                <div className="heading-title">
                    ...
                    <div className="wrap-breadcrumb div_flex" style={{ paddingBottom: '10px', alignItems: 'flex-start' }}>
                        <ListBreadcrumbs menu={'list'} name={'Industries'} subMenu={''} url={'/website-cms/industries'} />
                        <div className="wrap-btn">
                            <Link to={{ pathname: "/website-cms/industries/form/add/1" }}>
                            ...
                            {!isEmpty(data) && data.data.map((v, i) => (
                                <div key={i} className="content-table row">
                                    ...
                                    <div className="col-3" style={{ justifyContent: 'space-evenly', display: 'flex', textAlign: 'center' }}>
                                        <Link to={{ pathname: `/website-cms/industries/form/edit/${v.id}` }} className="a-href-label">Edit</Link>
                                        <Link to={{ pathname: `/website-cms/industries/form/detail/${v.id}` }} className="a-href-label">Detail</Link>
