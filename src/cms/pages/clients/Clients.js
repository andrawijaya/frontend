...
export default function Clients() {
  ...
  return (
    <div className="wrap-clients">
      ...
      <div className="wrap-inside-clients">
        <div className="heading-title">
          ...
          >
            ...
            <div className="wrap-btn">
              <Link to={{ pathname: "/website-cms/clients/form/add/1" }}>
        ...
        <div className="wrap-content-table__master-data">
          <div className="wrap-table-user">
            <div className="title-table row">
              <div className="col-3">Client Company Name</div>
              ...
              {!isEmpty(data) &&
                data.data.map((v, i) => (
                  <div key={i} className="content-table row">
                    ...
                    <div className="col-4">{v.web_url}</div>
                    <div
                      className="col-3"
                      style={{
                    ...
                    >
                      <Link
                        to={{
                          pathname: `/website-cms/clients/form/edit/${v.id}`,
                        }}
                      ...
                      <Link
                        to={{
                          pathname: `/website-cms/clients/form/detail/${v.id}`,
                        }}
                        className="a-href-label"
                      >
                        Detail
                      ...
                      <label
                        onClick={() =>
                          handleDeleteData(v.id, v.name, v.industry_count)
                        }
                        className="a-href-label"
                      >
                        Delete
